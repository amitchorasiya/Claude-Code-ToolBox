...
<!-- claude-code-toolbox:mcp-skills-awareness-begin -->

### MCP & Skills awareness (Claude Code ToolBox)

_Last synced: 2026-04-16T15:42:49.349Z._

- **Full report:** `.claude/claude-code-toolbox-mcp-skills-awareness.md` in this workspace (auto-overwritten on each scan). Use it as ground truth for configured servers and skill folders.
...
<!-- claude-code-toolbox:mcp-skills-awareness-end -->
